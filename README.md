...
**[Fela](https://github.com/rofrischmann/fela) did the great job, but it has no idea how to cook it with Vue.
...
- [fela-preset-dev](https://github.com/rofrischmann/fela/tree/master/packages/fela-preset-dev) (COMING SOON for only development ENV.)
